...
from .conftest import MyObject, MyRangeObject, query_data, range_query_data
...
def test_invalid_keys(populated_model):
    error_message = rf"Must only provide strings as `keys` to {populated_model.__name__}\.batch_get\(\)"
